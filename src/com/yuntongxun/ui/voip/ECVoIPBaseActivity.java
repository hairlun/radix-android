package com.yuntongxun.ui.voip;
...
import com.yuntongxun.ui.meeting.VoiceMeetingActivity;
import com.yuntongxun.ui.videomeeting.ECGlobalConstants;
import com.yuntongxun.ui.videomeeting.MultiVideoconference;
import com.yuntongxun.ui.voip.ECCallHeadUILayout.OnSendDTMFDelegate;

/**
 * com.yuntongxun.ui.voip in ECDemo_Android
...
public abstract class ECVoIPBaseActivity extends ECSuperActivity
    ...
    /**昵称*/
    public static final String EXTRA_CALL_NAME = "con.yuntongxun.VoIP_CALL_NAME";
    /**通话号码*/
    public static final String EXTRA_CALL_NUMBER = "con.yuntongxun.VoIP_CALL_NUMBER";
    /**呼入方或者呼出方*/
    public static final String EXTRA_OUTGOING_CALL = "con.yuntongxun.VoIP_OUTGOING_CALL";
    /**VoIP呼叫*/
    public static final String ACTION_VOICE_CALL = "con.yuntongxun.intent.ACTION_VOICE_CALL";
    /**Video呼叫*/
    public static final String ACTION_VIDEO_CALL = "con.yuntongxun.intent.ACTION_VIDEO_CALL";
    public static final String ACTION_CALLBACK_CALL = "con.yuntongxun.intent.ACTION_VIDEO_CALLBACK";
