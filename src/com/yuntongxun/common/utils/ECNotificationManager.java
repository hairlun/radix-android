...
import com.yuntongxun.ui.voip.ECVoIPBaseActivity;
...
public class ECNotificationManager {
    ...
    public static void showCallingNotification(ECVoIPCallManager.CallType callType) {
        try {
            ...
            Notification notification = new Notification.Builder(getInstance().mContext)
                    .setSmallIcon(R.drawable.title_bar_logo)
                    .setWhen(System.currentTimeMillis())
