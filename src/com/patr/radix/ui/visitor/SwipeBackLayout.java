...
import com.patr.radix.utils.AnimatorUtils;
import com.patr.radix.utils.YtxUtils;
...
public class SwipeBackLayout extends FrameLayout {
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        try {
            ...
            if(mDragHelper.getViewDragState() != ViewDragHelper.STATE_DRAGGING) {
                LogUtil.d("22222222222222222222222222");
                if (!mDragHelper.shouldInterceptTouchEvent(ev)) {
                    LogUtil.d("33333333333333333333333333333333");
            ...
            LogUtil.d("444444444444444444444444444444444");
    ...
    protected boolean drawChild(Canvas canvas, View child, long drawingTime) {
        LogUtil.d("drawChild " + drawingTime);
    ...
    public void markTranslucent(boolean translucent) {
        LogUtil.i("markTranslucent : " +translucent);
    ...
    public void computeScroll() {
        ...
        LogUtil.d("computeScroll :: mScrimOpacity " + mScrimOpacity);
    ...
    private class ViewDragCallback extends ViewDragHelper.Callback implements MethodInvoke.OnSwipeInvokeResultListener {
        ...
        public boolean tryCaptureView(View view, int i) {
            ...
            LogUtil.d("tryCaptureView i :" + i + " ,edgeTouched:" + edgeTouched);
            return edgeTouched;
        }
        ...
        public void onViewReleased(View releasedChild, float xvel, float yvel) {
            ...
            LogUtil.i("onViewReleased, xvel: " + xvel + " yvel: " + yvel + ", releaseLeft: " + left + ", releaseTop: " + top +", translucent: " + mTranslucent);
            if(!mTranslucent) {
                return ;
            }
        ...
        public void onViewDragStateChanged(int state) {
            ...
            LogUtil.d("onViewDragStateChanged state " + state + "mTranslucent " + mTranslucent + " , requestedTranslucent " + mRequestTranslucent + " fastRelease " + mFastRelease);
            ...
            if(state == ViewDragHelper.STATE_DRAGGING /*&& mScrolling*/ && (SwipeBackLayout.this.getContext() instanceof Activity) && !mTranslucent && !mRequestTranslucent) {
                LogUtil.i(" match dragging");
                mTranslucent = true;
                mActivity = ((Activity)SwipeBackLayout.this.getContext());
                if(Build.VERSION.SDK_INT >= 16) {
                    LogUtil.w("convertActivityToTranslucent::Android Version Error " + Integer.valueOf(Build.VERSION.SDK_INT));
                }
            }
            if(state == ViewDragHelper.STATE_SETTLING) {
                LogUtil.i("notify settle, mReleasedLeft " + mReleasedLeft);
            ...
            if(mActivity != null) {
                ...
                YtxUtils.convertActivityToTranslucent(mActivity , handler);
            }
        }
        ...
        public void onViewPositionChanged(View changedView, int left, int top, int dx, int dy) {
            ...
            LogUtil.d("onViewPositionChanged: Translucent : " + mTranslucent + "' ,left :"
            ...
            mContentTop = top;
            invalidate();
            LogUtil.d("onViewPositionChanged: mScrollPercent : " + mScrollPercent + "' ,mIsScrollOverValid :" + mIsScrollOverValid);
        ...
        public int clampViewPositionHorizontal(View child, int left, int dx) {
            LogUtil.d("clampViewPositionHorizontal : translucent : " + mTranslucent + " ,left " + left + " , dx " + dx);
            int ret = 0;
            if (mTranslucent) {
            ...
            LogUtil.d("clampViewPositionHorizontal ret " + ret);
            return ret;
        }
        ...
        public void onSwipeInvoke(final boolean result) {
            LogUtil.d("onSwipeInvoke :" + result );
            ECHandlerHelper.postRunnOnUI(new Runnable() {
                @Override
                public void run() {
                    LogUtil.i("on Complete, result " + result + " ,releaseLeft " + mReleasedLeft);
                    if(result) {
                        if(mReleasedLeft > 0) {
                            SwipeActivityManager.notifySwipe(0.0F);
