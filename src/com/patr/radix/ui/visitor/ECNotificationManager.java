...
public class ECNotificationManager {
    ...
    public static ECNotificationManager getInstance() {
        if(mInstance == null) {
            mInstance = new ECNotificationManager(App.instance.getApplicationContext());
        }
    ...
    private void cancel() {
        NotificationManager notificationManager = (NotificationManager) App.instance.getApplicationContext().getSystemService(Context.NOTIFICATION_SERVICE);
