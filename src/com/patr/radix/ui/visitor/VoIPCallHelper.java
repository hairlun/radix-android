...
public class VoIPCallHelper implements OnMakeCallBackListener {
    ...
    public static String makeCall(ECVoIPCallManager.CallType callType , String number) {
        ...
        if(getInstance().mCallInterface == null) {
            LogUtil.e("make call error : ECVoIPCallManager null");
            return null;
        }
    ...
    public static void makeCallBack(ECVoIPCallManager.CallType callType , String number) {
        ...
        callBackEntity.caller = App.instance.getMyMobile();
        callBackEntity.callerSerNum=number;
        
        
        
        callBackEntity.called=number;
        callBackEntity.calledSerNum=App.instance.getMyMobile();
    ...
    public static boolean getMute(){
        if(getInstance().mCallSetInterface == null) {
            LogUtil.e("get mute error : CallSetInterface null");
            return false;
        }
    ...
    public static boolean getHandFree(){
        if(getInstance().mCallSetInterface == null) {
            LogUtil.e("get hand free error : CallSetInterface null");
            return false;
        }
	...
	public static void setMute() {
		initCall();
		if (getInstance().mCallSetInterface == null) {
            LogUtil.e("set mute error : CallSetInterface null");
            return ;
		}
	...
	public static void setHandFree() {
		...
		initCall();
		if (getInstance().mCallInterface == null) {
            LogUtil.e("set hand free error : CallSetInterface null");
            return ;
		}
	...
	public static void releaseCall(String callId) {
		initCall();
		if (getInstance().mCallInterface == null) {
			LogUtil.e("release call error : ECVoIPCallManager null");
			return;
		}
    ...
    public static void acceptCall(String callId) {
        initCall();
        if(getInstance().mCallInterface == null) {
            LogUtil.e("accept call error : ECVoIPCallManager null");
            return ;
        }
    ...
    public static void rejectCall(String callId) {
        initCall();
        if(getInstance().mCallInterface == null) {
            LogUtil.e("reject call error : ECVoIPCallManager null");
            return ;
        }
        // 3 主动拒接
