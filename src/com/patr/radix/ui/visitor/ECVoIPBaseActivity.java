            ...
            if (infos != null && infos.length > 0) {
                for (String str : infos) {
                    if (str.startsWith(KEY_TEL)) {
                        mPhoneNumber = YtxUtils.getLastwords(str, "=");
                    } else if (str.startsWith(KEY_NAME)) {
                        mCallName = YtxUtils.getLastwords(str, "=");

//                        // 如果有以下两个值说明是会议邀请来电
//                    } else if(str.startsWith(KEY_CONFIG)) {
//                        mMeetingNo = YtxUtils.getLastwords(str, "=");
//                    } else if(str.startsWith(KEY_CONFIG_TYPE)) {
//                        mMeetingType = Integer.parseInt(YtxUtils.getLastwords(str, "="));
//                    }else if (str.startsWith(KEY_CONFIG_SUD)){
//                        LogUtil.d("get invitemeeting sud = "+YtxUtils.getLastwords(str,"="));
                    }
                }
            }
        }
