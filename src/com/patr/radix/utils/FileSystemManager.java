...
public class FileSystemManager {
    ...
    public static String getCacheFilePath(Context context) {
        cacheFilePath = FileUtil.getSDPath(context) + File.separator
                + "customerVisitor" + File.separator;
    ...
    public static String getCacheImgFilePath(Context context) {
        cacheImgFilePath = FileUtil.createNewFile(getCacheFilePath(context)
                + "img" + File.separator);
    ...
    public static String getUserHeadPath(Context context, String userId) {
        userHeadPath = FileUtil.createNewFile(getCacheFilePath(context)
                + "head" + File.separator + userId + File.separator);
        return userHeadPath;
    }
    ...
    public static String getDbPath(Context context) {
        dbPath = FileUtil.createNewFile(getCacheFilePath(context) + "database"
                + File.separator);
        return dbPath;
    }
    ...
    public static String getMallComplaintsPicPath(Context context, String userId) {
        mallComplaintsPicPath = FileUtil
                .createNewFile(getCacheFilePath(context) + "mallcomplaints"
                        + File.separator + userId + File.separator + "pic"
                        + File.separator);
     ...
     * @see [类、类#方法、类#成员]
     */
    public static String getMallComplaintsVoicePath(Context context,
            String userId) {
        mallComplaintsVoicePath = FileUtil
                .createNewFile(getCacheFilePath(context) + "mallcomplaints"
                        + File.separator + userId + File.separator + "voice"
                        + File.separator);
    ...
    public static String getCrashPath(Context context) {
        crashPath = FileUtil.createNewFile(getCacheFilePath(context) + "crash"
                + File.separator);
        return crashPath;
    }
    ...
    /**
     * 
     * <圈子发帖缓存目录（删除上次发帖缓存，保存本次发帖纪录）> <功能详细描述>
     * 
     * @param context
     * @return
     * @see [类、类#方法、类#成员]
    ...
    public static String getPostPath(Context context) {
        postPath = FileUtil.createNewFile(getCacheFilePath(context) + "post"
                + File.separator);
        return postPath;
    }
    ...
    public static String getTemporaryPath(Context context) {
        temporaryPath = FileUtil.createNewFile(getCacheFilePath(context)
                + "temp" + File.separator);
    ...
    public static String getVersionUpdatePath(Context context) {
        versionUpdate = FileUtil.createNewFile(getCacheFilePath(context)
                + "versionupdate" + File.separator);
